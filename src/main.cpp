...
static float32_t values[6] = {3.0,5.0,4.0,6.0,1.0,2.0}; // Example values to be sorted
...
void setup_routine()
{
    ...
    scope.connectChannel(values[3], "value 4");
    scope.connectChannel(values[4], "value 5");
    scope.connectChannel(values[5], "value 6");
